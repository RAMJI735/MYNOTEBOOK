      ...
      <section className="py-10 dark:bg-gray-100 dark:text-gray-900">
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          <div className="py-6 md:py-0 md:px-6">
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-center">
                ...
                <span>dipanshusrivastava.735@gmail.com</span>
              </p>
            </div>
          </div>
          <form noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
            ...
            <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-rose-600 dark:text-gray-50 focus:dark:ring-rose-600 hover:dark:ring-rose-600" fdprocessedid="c15sgd">Submit</button>
          </form>
        </div>
      </section>
    )
