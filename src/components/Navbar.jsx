...
const Navbar = () => {
  ...
  const { setAllNotes } = useNotesContext();
  const logoutFun = () => {
      ...
      <header className="p-4 dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex justify-between h-16 mx-auto">
          <a aria-label="Back to homepage" className="flex items-center p-2">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-rose-500">
              <svg
          ...
          <div className="flex items-center max-lg:hidden -mx-4 overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap dark:bg-gray-100 dark:text-gray-800">
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                } flex items-center flex-shrink-0 px-5 py-3 space-x-2 dark:border-gray-600 dark:text-gray-900`
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              to="/login"
              className="border-b flex items-center flex-shrink-0 px-5 py-3 space-x-2 dark:border-gray-600 dark:text-gray-900"
               >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="flex items-center md:space-x-4">
            ...
            {localStorage.getItem("token") ? (
              <button
                className="hidden px-6 py-2 font-semibold rounded lg:block bg-rose-600 dark:text-gray-50"
